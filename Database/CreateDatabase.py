...
def create_database():
    ...
    try:
        ...
        posterQuery = "CREATE TABLE IF NOT EXISTS posters(poster_id INTEGER PRIMARY KEY AUTOINCREMENT, poster_title STRING NOT NULL, poster_emails STRING NOT NULL, poster_category STRING NOT NULL, poster_description STRING, img_ext STRING);"
